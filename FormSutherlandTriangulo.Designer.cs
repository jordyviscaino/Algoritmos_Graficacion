namespace Algoritmos_Graficacion
{
    partial class FormSutherlandTriangulo
    {
        ...
        private void InitializeComponent()
        {
            ...
            pictureBox1.Size = new Size(975, 410);
            ...
            label5.Location = new Point(1057, 252);
            label5.Name = "label5";
            label5.Size = new Size(340, 140);
            label5.TabIndex = 17;
            ...
            label6.Location = new Point(1088, 183);
            label6.Name = "label6";
            label6.Size = new Size(202, 50);
            label6.TabIndex = 16;
            label6.Text = "Recorte Generalizado\r\n (Ventana Triangular)";
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.BackColor = Color.LemonChiffon;
            label2.Location = new Point(1057, 425);
            label2.Name = "label2";
